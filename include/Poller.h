...
public:
  ...
  // ========================================================================
  // MILESTONE 5: POWER OPTIMIZATION (DISABLED FOR SIMULATION)
  // Enable for real RS-485 hardware deployment only
  // Only enableLightSleep() and isLightSleepEnabled() are used
  // ========================================================================
  void enableLightSleep(bool enable) { _sleepEnabled = enable; }
  bool isLightSleepEnabled() const { return _sleepEnabled; }
  // END MILESTONE 5 PUBLIC METHODS
  // ========================================================================
...
private:
  ...
  // ========================================================================
  // MILESTONE 5: POWER OPTIMIZATION MEMBER (DISABLED FOR SIMULATION)
  // Enable for real RS-485 hardware deployment only
  // ========================================================================
  bool _sleepEnabled = false;           // Enable/disable light sleep
  // END MILESTONE 5 MEMBER
  // ========================================================================
